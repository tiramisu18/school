...
var Route = function (_React$Component) {
  ...
  Route.prototype.computeMatch = function computeMatch(_ref, _ref2) {
    ...
    return path ? Object(__WEBPACK_IMPORTED_MODULE_3__matchPath__["default"])(pathname, { path: path, strict: strict, exact: exact }) : route.match;
  };
...
var Switch = function (_React$Component) {
  ...
  Switch.prototype.render = function render() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.forEach(children, function (element) {
      ...
      if (match == null) {
        child = element;
        match = path ? Object(__WEBPACK_IMPORTED_MODULE_3__matchPath__["default"])(location.pathname, { path: path, exact: exact, strict: strict }) : route.match;
      }
    });
